...
class BloggifyTemplate {
     ...
     * @param  {String} tmplPath The path of the template.
     */
...
module.exports = class BloggifyThemeRenderer {
    ...
    constructor (bloggify) {
        ...
        this.package = ul.deepMerge(readJson(`${this.themeRoot}/package.json`), {
            bloggify: {
                templates: {}
              , data: {}
            }
        });
        bloggify.options.theme = ul.deepMerge(bloggify.options.theme, this.package.bloggify.data);
        this.renderHookName = "custom:render_data";
        this.templates = {};
        this.renderers = {};
        bloggify.handleBundleConfig(this.package.bloggify, this.themeRoot);
        forEach(this.package.bloggify.templates, (val, name) => {
     ...
     * @param  {Object} transType  The translation field.
